...
<center>**Food Insecurity Rate by Borough in NYC**</center>
Use the map below to identify the food insecurity rate by borough. 
...
writeOGR(zip_map_crs, './data/zip_map_geojson', layer = 'zip_map_layer7', driver = 'GeoJSON')
```
