...
<h2>Findings</h2>
The association between food insecurity and tbe select chronic health outcomes was assessed via logistic regression, adjusting for race, sex, age.

## Logistic Regression
 
**Obesity**
$$ logit(Obesity) \sim \beta_0 + \beta_1 Food Insecure_i + \beta_2 Age_i + \beta_3 Sex_i  + \beta_4 Race_i$$
...
**High Blood Pressure**
$$ logit(HighBloodPressure) \sim \beta_0 + \beta_1 Food Insecure_i + \beta_2 Age_i + \beta_3 Sex_i  + \beta_4 Race_i$$
...
**Depression**
$$ logit(Depression) \sim \beta_0 + \beta_1 Food Insecure_i + \beta_2 Age_i + \beta_3 Sex_i  + \beta_4 Race_i$$
...
**Diabetes**
 $$ logit(Diabetes) \sim \beta_0 + \beta_1 Food Insecure_i + \beta_2 Age_i + \beta_3 Sex_i  + \beta_4 Race_i$$
```{r}
...
<h3>Spatial Visualization of Food Insecurity Rate by Borough in NYC</h3>
<center>
...
writeOGR(zip_map_crs, './data/zip_map_geojson', layer = 'zip_map_layer41', driver = 'GeoJSON')
```
